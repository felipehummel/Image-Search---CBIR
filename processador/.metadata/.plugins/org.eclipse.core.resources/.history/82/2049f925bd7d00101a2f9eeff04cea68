...
public class HitQueue extends PriorityQueue<ImageScore> {
  ...
  private final boolean COMPARISON_MEASURE;
   ...
   */
  HitQueue(int size, boolean prePopulate, boolean _comparison_measure) {
    this.prePopulate = prePopulate;
    this.COMPARISON_MEASURE = _comparison_measure;
    initialize(size);
  }
  ...
  protected ImageScore getSentinelObject() {
    ...
    // TopScoreDocCollector will always add the object to the queue.
	  if (COMPARISON_MEASURE) 		//distancia
